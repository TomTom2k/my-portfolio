...
export default function Intro({ profile, socialLinks }: IntroProps) {
  ...
  // Fallback values
  const name = profile?.name || "Thanh Tin";
  ...
  const avatarUrl = profile?.avatar_url || "/avatar.webp";
  const cvUrl = profile?.cv_url || "/ThanhTinCV.pdf";
        ...
        {socialLinks.map((socialLink) => {
          ...
          return (
            <a
              ...
              target="_blank"
            >
              {IconComponent ? <IconComponent /> : socialLink.platform}
            </a>
          );
        })}
      </motion.div>
